...
(function () {
    ...
    Face.prototype.draw = function () {
        ...
        if (framesOnly) {
            ...
            canvas.ctx.lineTo(this.p0.X, this.p0.Y);
            canvas.ctx.strokeStyle = "rgba(" + r + ", " + g + ", " + b + ", " + this.cube.alpha + ")";
            canvas.ctx.stroke();
            if (this == faceOver) {
                canvas.ctx.fillStyle = "rgba(" + r + ", " + g + ", " + b + ", " + this.cube.alpha + ")";
                canvas.ctx.fill();
            }
    ...
    var Star = function (cx, cy, cz, spikes, outerRadius, parent, normalVector) {
        ...
        var pointStart = new Point(parent, shuffleCoordinates([cx, cy - outerRadius, cz], normalVector, [cx, cy, cz]), true);
    ...
    Star.prototype.calculateInnerRadius = function (spikes, outerRadius) {
        if (spikes % 2 == 0) {
    ...
    var init = function () {
        ...
        scr.ontouchmove = scr.onmousemove = function (e) {
            ...
            if (drag) {
                cx = cxb + (xm - startX);
                cy = cyb - (ym - startY);
                document.getElementById("cmove").innerHTML = cx + ", " + cy;
            }
        ...
        // ---- camera angle ----
        setInterval(function () {
            document.getElementById('cangle').innerHTML = angleX.toFixed(0) + ', ' + angleY.toFixed(0) + ', ' + angleZ.toFixed(0);
        ...
        document.getElementById("nStarEdges").onchange = function () {
            ...
            nStarEdges = this.value = intValue;
        }
